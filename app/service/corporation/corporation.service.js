...
var CorporationService = (function () {
    function CorporationService(http, commonHttpService, commonUtil) {
        this.http = http;
        this.commonHttpService = commonHttpService;
        this.commonUtil = commonUtil;
    }
    CorporationService.prototype.queryCorporation = function (corpSearchParameters) {
        var queryUrl = '/MD/corporations';
